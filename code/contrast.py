...
class Contrast(nn.Module):
    ...
    def Random_walk_random(self, random_walk_drop_prob):
        return 0
    ...
    def get_views(self):
        ...
        if world.config['model'] == 'SGL-ED':#边dropout
            if (world.config['pop_mode'] == 'SGL3' or world.config['pop_mode'] == 'SGL4') and world.config['if_pop']:
        ...
        elif world.config['model'] == 'SGL-FM':#节点属性mask
            UIv1 = self.Random_walk_random(world.config['edge_drop_prob'])
            UIv2 = self.Random_walk_random(world.config['edge_drop_prob'])
