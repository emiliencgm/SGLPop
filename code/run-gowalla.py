...
for drop in [0.05, 0.1, 0.2, 0.3, 0.4]:
    for add in [0.6, 0.7, 0.8, 0.9, 1.0]:
        P_e_drop1, P_e_drop2 = drop, drop
        P_e_add1, P_e_add2 = add, add
        os.system('python main.py --if_big_matrix 0 --n_fold 2 --edge_drop_prob 0.1 --dataset gowalla --if_pop 1 --pop_mode SGL5 --cuda {} --P_e_drop1 {} --P_e_add1 {} --P_e_drop2 {} --P_e_add2 {} --model SGL-ED --comment SGL5_Adaptive_ED_HyperParamSearch'.format(cuda, P_e_drop1, P_e_add1, P_e_drop2, P_e_add2))